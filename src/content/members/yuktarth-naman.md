...
status: "department"
order: 16
photo: "/team_pics/members/yuktarth_naman.png"
...
contributions:
  ...
  - title: Juris-Genie
    description: |-
      ...
      AI extracts data (probabilistic) → Data enters a pure-function engine (deterministic) → Results are cryptographically hashed → Hashes are anchored on-chain (immutable).

      Legal document review and case synthesis take hours of expensive manual labor. Juris Genie automates key clause extraction, risk detection, and case summaries in seconds.
    url: https://jurisgenie-pro-6ijp.onrender.com/pro

awards:
  - title: Frostbyte Hackthon
    date: June 2026
