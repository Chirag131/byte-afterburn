      ...
      <div className="whoarewe-inner">
        ...
        >
          ...
          <div className="whoarewe-portrait-stage" aria-hidden="true">
            ...
            >
              <img className="whoarewe-lab-frame" src="/assets/lab_frame.png" alt="" width="2380" height="1792" loading="lazy" decoding="async" />
              <img className="whoarewe-lab-outer" src="/assets/lab_outer.png" alt="Byte Tech Society laboratory" width="2380" height="1792" loading="lazy" decoding="async" />
              <img className="whoarewe-lab-reveal" src="/assets/lab_frame.png" alt="" width="2380" height="1792" loading="lazy" decoding="async" />
            </div>
          </div>
        </div>
      </div>
